<%@ Page Title="" Language="C#" ValidateRequest="false" MasterPageFile="~/BrightspaceTools.master" ViewStateMode="Enabled" ViewStateEncryptionMode="Never" EnableViewStateMac="false"  AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="QuizGenerator" %>
    ...
    <center>
        ...
        <table style="background-color:#f6f6f6;padding:10px;">
            <tr>
                <td colspan="2" align="left">
                    ...
                    <table id="instructionsTable" border="0" width="100%" style="padding:0px;">
                        <tr>
                            <td colspan="2">
                                <img src="NewStyle/App_Themes/General/images/Logos-02.png" />
                                <h1>TEST QUESTION GENERATOR</h1>
                                <br />
                                <br />
                                <h2>INSTRUCTIONS <a id="instructions" href="Default.aspx"><img src="NewStyle/App_Themes/General/images/question_mark_small.png" /></a></h2>
                                Type or paste your questions into the main text area and click the Generate Test Questions button.<br /><br />
					            ...
					            <ul>
					                ...
					                <li>If you enter questions/answers without numbers/letters, then questions must be tagged (MC for multiple choice, TF for true/false, MA for multiple answer, etc).</li>
                                    <li>Separate your questions with one blank line. </li>
					                <li>Avoid leaving blank rows, except when you're going on to the next question or answer.</li>
					            </ul>
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <asp:Button class="myButton" ID="btnCreateSample" Text="CREATE" OnClick="OnCreateSample" runat="server" />
                </td>
            </tr>
            <tr>
                <!-- Quiz entry area -->
                <td align="left
                    " colspan="2">
                    <asp:Panel ID="panelQuiz" Width="100%" Height="100%" ScrollBars="None" style="min-height:450px" runat="server">
            ...
            <tr>
                <td align="center" colspan="2">
                    <asp:Button class="myButton" ID="btnGenerate" Width="250px" Text="Generate Test Questions" runat="server" OnClick="OnGenerate" />
                    &nbsp;
                    <asp:Button class="myButton" ID="btnClear" Width="250px" Text="Clear Test Questions" runat="server" OnClick="OnClear" />
                </td>
            </tr>
        </table>
        ...
        <asp:Panel ID="panelDownload" style="padding-top:0px" BackColor="White" BorderColor="Green" BorderWidth="1" width="650px" Height="120px" runat="server" Visible="false">
            <table width="70%" border="0">
                <tr>
                    <td align="center">
                        <asp:Button class="myButton" ID="btnDownloadTest" ToolTip="Download questions for the test area in Blackboard" Font-Bold="true" Text="Download Test Questions" Width="200px" Height="50px" OnClick="OnDownloadTest" runat="server" />
                    </td>
                    <td align="center">
                        <asp:Button class="myButton" ID="btnDownloadPool" ToolTip="Download questions for the pool area in Blackboard" Font-Bold="true" Text="Download Question Pool" Width="200px" Height="50px" OnClick="OnDownloadPool" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button class="myButton" ID="btnDownloadBrightspace" ToolTip="Download questions for the test area in Brightspace" Font-Bold="true" Text="Download Test Questions for Brightspace" Width="300px" Height="50px" OnClick="OnDownloadBrightspace" runat="server" />
                    </td>
                </tr>
            </table>
            <br />
